...
const SearchBar = () => {
  ...
  return (
    <div className="  w-96   md:w-4/5 lg:w-4/5 xl:w-4/5 mx-auto rounded-md overflow-hidden">
      <div style={{ display: "flex", alignItems: "center" }} >
        ...
        <button
          ...
          className=" bg-green-700 text-white mr-8 px-4 py-2 border-2 rounded-md hover:bg-green-900 mt-1"
        >
          Search
        </button>
