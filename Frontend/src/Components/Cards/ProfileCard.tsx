  ...
  return (
    <div className=" flex flex-col gap-4 p-4 w-fit max-h-[100vh]">
      <dialog className="modal bg-[#f4f4f450]" ref={modalRef}>
        <form
          method="dialog"
          className="modal-box flex flex-col bg-neutral-100 gap-6 "
        >
      ...
      <button
        className=" bg-green-700 rounded-md border-neutral-500 
            border-[1px] hover:border-neutral-300 text-neutral-100"
        type="button"
        onClick={() => handleEdit()}
      >
        Edit
